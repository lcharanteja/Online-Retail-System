function Submit(){
	...
	var dept=checkDept();
	if(itemname==true&&itemprice==true&&quantity==true&&flavor==true&&status==true&&avail==true&&dept==true)
	{
	return true;
	}
else
	...
	{
		var itemStatus=document.form.cancellationstatus.value;
	...
	{
		var itemAvailStatus=document.form.availabilitystatus.value;
		
		  if(itemAvailStatus=="-1")
		    {
