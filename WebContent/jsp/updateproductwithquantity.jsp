...
<span  style="color: #FE6847">Price:</span><%= ib.getItemPrice()%><span>&nbsp;&nbsp;&nbsp;&nbsp;

<span  style="color: #FE6847">Available Quantity:</span><%= (ib.getItemQuantity())%><span>&nbsp;&nbsp;<br></center>
<center><span  style="color: #FE6847">Select Quantity: </span><input type="text" value="<%=session.getAttribute("BuyQuan") %>" name="quantity" style="width: 50px; height: 25px;" onblur="validateQuantity(<%= (ib.getItemQuantity())%>)"></center>
