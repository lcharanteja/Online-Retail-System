...
<div class="main">
		<div class="container">
				 ...
				 <form action="<%=request.getContextPath() %>/ProfileController" name="form" onsubmit="return Submit()">
				 ...
				 <tr>
						...
						<td align="left" style="width: 60%"><input type="text" name="email" placeholder="xyz@domain.com" onblur="checkemail()">
						<SPAN STYLE="color: red" ID="email_error"></SPAN></td>
					</tr>
					<tr>
						<td>Last Name<label style="color: red">*</label></td>
						<td align="left" style="width: 60%"><input type="text" name="lastname" onblur="checklname()">
				 ...
				 <input class="myButton" type="submit" name="source" value="submit" >
				  </center>
				 </form>
