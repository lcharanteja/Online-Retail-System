...
<div class="main">
		<div class="container">
				 ...
				 <center>
				 <h3 style="color:green"> &#10004; Dear customer your account deactivated successfully. </h3>
				<br><h3 style="color:green"><a  href="<%=request.getContextPath() %>/jsp/index.jsp">Click here </a>to login</h3>	 </center>
				</div>
					</ul>
				</div>
			</div>
