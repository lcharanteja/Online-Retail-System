...
<!-- 			</ul> -->
		...
		<div class="header_bottom">
		  <div class="header_nav">
      		<div class="logo">
				<a href="<%=request.getContextPath() %>/jsp/home.jsp"><img src="<%=request.getContextPath() %>/images/logo4.png" alt=""/ width = 120px height = 120px><br></a>
			 </div>
	          ...
	          <div class="account_grid">
			   <div class="col-md-6 login-left" style="width:400px">
				 ...
				 <a class="acount-btn" href="<%=request.getContextPath() %>/jsp/register.jsp">Create an Account</a>&nbsp;&nbsp;
				  <a class="acount-btn" href="<%=request.getContextPath() %>/CartController?source=start">Continue As Guest</a>
			   </div>
			   <div class="col-md-6 login-right" style="margin-left:35px">
				...
				<input type="hidden" name="source" value="login">
				  <div>
					...
					<input type="text" name="id" placeholder="xyz@domain.com" onblur="checkemail()"> 
				  </div>
				  <div>
					<span>Password<label>*</label></span>
					<input type="password" name="pwd" style="width:388px;height:40px"> 
				  </div>
				  <a class="forgot" href="<%=request.getContextPath()%>/ProfileController?source=forgotpassword">Forgot Your Password?</a>
