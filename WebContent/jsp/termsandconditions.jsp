		...
		<div class="container">
			...
			<div style="margin: 50px">
				...
				<table style="text-align: justify;">
					...
					<tr>
						<td>This website is operated by BON APPETTIT. Throughout the
							site, the terms “we”, “us” and “our” refer to BON APPETTIT. BON
							APPETTIT offers this website, including all information, tools
							...
							customers, merchants, and/ or contributors of content. Please
							...
							constitutes acceptance of those changes.</td>
					</tr>
...
<tr><td>&nbsp;</td></tr>
					...
					<tr class="red">
						<td>SECTION 1 - ONLINE STORE TERMS</td>
					</tr>

					<tr>
						<td>By agreeing to these Terms of Service, you represent that
							...
							any of your minor dependents to use this site. You may not use
							our products for any illegal or unauthorized purpose nor may you,
							...
							an immediate termination of your Services.</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 2 - GENERAL CONDITIONS</td>
					</tr>

					<tr>
						<td>We reserve the right to refuse service to anyone for any
							...
							limit or otherwise affect these Terms.</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF
							INFORMATION</td>
					</tr>

					<tr>
						<td>We are not responsible if information made available on
...
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</td>
					</tr>

					<tr>
						<td>Prices for our products are subject to change without
...
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 5 - PRODUCTS OR SERVICES (if applicable)</td>
					</tr>

					<tr>
						<td>Certain products or services may be available exclusively
							...
							any errors in the Service will be corrected.</td>
					</tr>
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</td>
					</tr>

					<tr>
						<td>We reserve the right to refuse any order you place with
							...
							make a change to or cancel an order, we may attempt to notify you
							by contacting the e-mail and/or billing address/phone number
							...
							placed by dealers, resellers or distributors. You agree to
							...
							needed. For more detail, please review our Returns Policy.</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 7 - OPTIONAL TOOLS</td>
					</tr>

					<tr>
						<td>We may provide you with access to third-party tools over
							...
							services shall also be subject to these Terms of Service.</td>
					</tr>
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 8 - THIRD-PARTY LINKS</td>
					</tr>

					<tr>
						<td>Certain content, products and services available via our
							...
							directed to the third-party.</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr class="red">
					<td>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS

					</td>
					</tr>

					<tr>
					<td>If, at our request, you send certain specific submissions
						...
						for any comments posted by you or any third-party.</td>
					</tr>
<tr><td>&nbsp;</td></tr>
					<tr class="red">
					<td>SECTION 10 - PERSONAL INFORMATION</td>
					</tr>
					<tr>
						<td>Your submission of personal information through the store
							is governed by our Privacy Policy. To view our Privacy Policy.</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</td>
					</tr>

					<tr>
						<td>Occasionally there may be information on our site or in
							...
							or on any related website has been modified or updated.</td>
					</tr>
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 12 - PROHIBITED USES</td>
					</tr>

					<tr>
						<td>In addition to other prohibitions as set forth in the
							Terms of Service, you are prohibited from using the site or its
...
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF
							LIABILITY</td>
					</tr>
					...
					<tr>
						<td>We do not guarantee, represent or warrant that your use
							...
							any time, without notice to you. You expressly agree that your
							...
							a particular purpose, durability, title, and non-infringement. In
							no case shall BON APPETTIT, our directors, officers, employees,
							...
							extent permitted by law.</td>
					</tr>

<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 14 - INDEMNIFICATION</td>
					</tr>

					<tr>
						<td>You agree to indemnify, defend and hold harmless BON
							APPETTIT and our parent, subsidiaries, affiliates, partners,
							...
							<tr><td>&nbsp;</td></tr>
						<tr class="red">
					<td>SECTION 15 - SEVERABILITY</td>
					</tr><tr>
						<td>In the event that any provision of these Terms of Service
							...
							any other remaining provisions.</td>
					</tr>
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 16 - TERMINATION</td>
					</tr>

					<tr>
						<td>The obligations and liabilities of the parties incurred
...
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 17 - ENTIRE AGREEMENT</td>
					</tr>
					<tr>
						<td>The failure of us to exercise or enforce any right or
...
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 18 - GOVERNING LAW</td>
					</tr>

					<tr>
						<td>These Terms of Service and any separate agreements
							whereby we provide you Services shall be governed by and
							construed in accordance with the laws of SANTUARY COVE DRIVE
							TAMPA FLORIDA USA 53214.</td>
					</tr>
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 19 - CHANGES TO TERMS OF SERVICE</td>
					</tr>

					<tr>
						<td>You can review the most current version of the Terms of
							...
							Service constitutes acceptance of those changes.</td>
					</tr>
<tr><td>&nbsp;</td></tr>
					<tr class="red">
						<td>SECTION 20 - CONTACT INFORMATION</td>
					</tr>

					<tr>
						<td>Questions about the Terms of Service should be sent to us
							at contactus@BonAppettit.com.</td>
					</tr>
				</table>
			</div>
		</div>
